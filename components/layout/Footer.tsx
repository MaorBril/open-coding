        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Technical Assessment in the GenAI World helps candidates and interviewers
              adapt to AI-augmented technical interviews.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>• Realistic Work Samples</li>
              <li>• Responsible AI Use</li>
              <li>• Focus on Reasoning</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>
                <a href="#for-candidates" className="hover:text-white transition-colors">
                  Candidate Training
                </a>
              </li>
              <li>
                <a href="#for-interviewers" className="hover:text-white transition-colors">
                  Interviewer Guide
                </a>
              </li>
            </ul>
