        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-5xl mx-auto mb-12">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white/50 bg-gradient-to-br from-gray-100 to-gray-200 aspect-video group hover:scale-[1.02] transition-all duration-300">
              <div className="absolute inset-0 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-accent-900/90 to-primary-900/90 backdrop-blur-sm">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">The AI Interview Challenge</h3>
                <p className="text-white/90 text-center max-w-2xl text-sm leading-relaxed">
                  <strong>Image Prompt:</strong> Split-screen - Left: nervous candidate copy-pasting from ChatGPT (red tint), Right: confident candidate explaining code to engaged interviewer (green tint), professional interview setting
                </p>
              </div>
            </div>
          </div>
