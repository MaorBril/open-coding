      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mb-16 max-w-5xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white/50 bg-gradient-to-br from-gray-100 to-gray-200 aspect-video group hover:scale-[1.02] transition-all duration-300">
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-primary-900/90 to-purple-900/90 backdrop-blur-sm">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">See the Playground Interface</h3>
              <p className="text-white/90 text-center max-w-2xl text-sm leading-relaxed">
                <strong>Image Prompt:</strong> Modern web app UI with sidebar navigation, main content showing good vs bad comparison cards with green and red color coding, clean professional interface, glassmorphic design
              </p>
            </div>
          </div>
        </div>
